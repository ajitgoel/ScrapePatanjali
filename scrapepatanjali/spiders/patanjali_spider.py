...
class PatanjaliSpider(scrapy.Spider):
    ...
    def parse_parent(self, response):
        ...
        for child_url in child_urls:
            yield scrapy.Request(
                url=response.urljoin(child_url), callback=self.parse_child
            )
    ...
    def parse_child(self, response):
        ...
        # data["breadcrumb1"] = (
        #     response.css(
        #         "div.block-breadcrumb>ul.breadcrumb>li:nth-child(2)>a::text"
        #     ).get(),
        # )
        # data["breadcrumb2"] = (
        #     response.css(
        #         "div.block-breadcrumb>ul.breadcrumb>li:nth-child(3)>a::text"
        #     ).get(),
        # )
        # data["lastbreadcrumb"] = (
        #     response.css("div.block-breadcrumb>ul.breadcrumb>li.active::text").get(),
        # )
        # data["heading"] = (response.css("div.product-detail-section>h3::text").get(),)
        # data["product-information"] = (
        #     "<b>Product Information</b>"
        #     + response.css("div.product-information>div>p>font::text").get()
        #     + "\n<b>Benefits</b>"
        #     + response.css("#collapse1>div::text").get()
        #     + "\n<b>Ingredients</b>"
        #     + response.css("#collapse2>div::text").get()
        #     + "\n<b>How to use</b>"
        #     + response.css("#collapse3>div>div:nth-child(1)>font::text").get()
        #     + "\n<b>Other Product Info</b>"
        #     + response.css("#collapse4>div.panel-body>font::text").get(),
        # )
        # data["weight"] = (
        #     response.css(
        ...
        #     ).get(),
        # )
        # data["product-image"] = (response.css("#product-main::attr(src)").get(),)
